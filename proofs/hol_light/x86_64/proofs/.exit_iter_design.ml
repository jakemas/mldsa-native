(* Correct decomposition of MLDSA_REJ_UNIFORM_ETA4_CORRECT's SIMD loop, given the production
   ...
   iteration (a mid-guard can fire -> exit at pc+314 with pos=16i+4k, partial ctr).
   ...
   and exits to pc+314. The per-sub-iter gather/fold tactics (SI1_FOLD_V2, SI2/3/4_INTEGRATED)
