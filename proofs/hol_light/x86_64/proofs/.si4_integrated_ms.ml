(* SI4_INTEGRATED_MS: full sub-iter-4 (gather + store-fold + counter + jmp), cheat-free.
...
let SI4_INTEGRATED_MS : tactic =
  ...
  X86_VERBOSE_STEP_TAC EXEC "s49" THEN MOVZBL_R10_CAPTURE_MS_TAC THEN
  ...
  X86_STEPS_KEEPEV_TAC EXEC (53--53) THEN
  ...
  X86_STEPS_KEEPEV_TAC EXEC (54--57);;
