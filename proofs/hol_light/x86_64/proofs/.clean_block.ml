(* ========================================================================= *)
(* CLEAN_BLOCK (2026-06-24): the SIMD 16-byte block body pc+56 -> pc+56,        *)
...
(* CLEAN_BLOCK @ i=N-1 takes pc+56/pos=16(N-1) -> pc+56/pos=16N, then the head    *)
(* guard cmp ecx,256 fires (16N=272>256) -> pc+318, then SCALAR_TAIL_AT_P@272.    *)
